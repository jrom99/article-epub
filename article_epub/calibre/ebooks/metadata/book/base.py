...
from article_epub.calibre.ebooks.metadata.book import ALL_METADATA_FIELDS, SC_COPYABLE_FIELDS, SC_FIELDS_COPY_NOT_NULL, STANDARD_METADATA_FIELDS, TOP_LEVEL_IDENTIFIERS
from article_epub.calibre.library.field_metadata import FieldMetadata
from article_epub.calibre.utils.icu import lower as icu_lower
from article_epub.calibre.utils.icu import sort_key
from article_epub.calibre.utils.localization import ngettext
...
class Metadata:
    ...
    def __init__(self, title, authors=(_('Unknown'),), other=None, template_cache=None,
        ...
        from article_epub.calibre.ebooks.metadata.book.formatter import SafeFormat

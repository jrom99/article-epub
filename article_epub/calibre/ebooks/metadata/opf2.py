...
from article_epub.calibre import guess_type, prints
from article_epub.calibre.constants import __appname__, __version__, filesystem_encoding
from article_epub.calibre.ebooks import escape_xpath_attr
from article_epub.calibre.ebooks.metadata import MetaInformation, check_isbn, string_to_authors
from article_epub.calibre.ebooks.metadata.book.base import Metadata
from article_epub.calibre.ebooks.metadata.toc import TOC
from article_epub.calibre.ebooks.metadata.utils import parse_opf
from article_epub.calibre.ebooks.metadata.utils import pretty_print_opf as _pretty_print
from article_epub.calibre.utils.cleantext import clean_ascii_chars, clean_xml_chars
from article_epub.calibre.utils.config import tweaks
from article_epub.calibre.utils.date import isoformat, parse_date
from article_epub.calibre.utils.icu import lower as icu_lower
from article_epub.calibre.utils.icu import upper as icu_upper
from article_epub.calibre.utils.localization import canonicalize_lang, get_lang
from article_epub.calibre.utils.xml_parse import safe_xml_fromstring
from article_epub.calibre.polyglot_urllib import unquote, urlparse
...
class OPF:  # {{{
    ...
    def read_user_metadata(self):
        ...
        temp = Metadata('x', ['x'])
        from article_epub.calibre.ebooks.metadata.book.json_codec import decode_is_multiple
        from article_epub.calibre.utils.config import from_json

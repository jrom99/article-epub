...
from article_epub.calibre.customize.conversion import InputFormatPlugin, OptionRecommendation
...
class EPUBInput(InputFormatPlugin):
    ...
    def rationalize_cover3(self, opf, log):
        ...
        from article_epub.calibre.ebooks.metadata.opf3 import items_with_property
    ...
    def convert(self, stream, options, file_ext, log, accelerators):
        from article_epub.calibre import walk
        from article_epub.calibre.ebooks import DRMError
        ...
        try:
            ...
            from article_epub.calibre.utils.localunzip import extractall
    ...
    def convert_epub3_nav(self, nav_path, opf, log, opts):
        ...
        from article_epub.calibre.ebooks.oeb.base import (
            EPUB_NS,
            NCX,
            NCX_MIME,
            XHTML,
        ...
        from article_epub.calibre.ebooks.oeb.polish.parsing import parse
        from article_epub.calibre.ebooks.oeb.polish.toc import first_child
        from article_epub.calibre.utils.xml_parse import safe_xml_fromstring
        from lxml import etree
        ...
        def add_from_li(li, parent):
            ...
            for x in li.iterchildren(XHTML("a"), XHTML("span")):
                text = (
                    etree.tostring(x, method="text", encoding="unicode", with_tail=False).strip()

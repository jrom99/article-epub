...
sys.resources_location = os.path.join(parent, "resources")

from article_epub.calibre.constants import (
    __appname__,
    __author__,
    __version__,
    config_dir,
...
from article_epub.calibre.startup import initialize_calibre

initialize_calibre()
from article_epub.calibre.prints import prints
from article_epub.calibre.utils.icu import safe_chr
from article_epub.calibre.utils.resources import get_path as P

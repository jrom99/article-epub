...
from article_epub.calibre.constants import iswindows
from article_epub.calibre.prints import is_binary
...
def colored(text: str | bytes, fg=None, bg=None, bold=False):
    prefix = []
    if fg is not None:

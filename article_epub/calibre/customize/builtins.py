...
from article_epub.calibre.constants import numeric_version
from article_epub.calibre.customize import FileTypePlugin, InterfaceActionBase, MetadataReaderPlugin, MetadataWriterPlugin, PreferencesPlugin, StoreBase
from article_epub.calibre.ebooks.html.to_zip import HTML2ZIP
from article_epub.calibre.ebooks.metadata.archive import ArchiveExtract, KPFExtract, get_comic_metadata
...
# Conversion plugins {{{
# from article_epub.calibre.ebooks.conversion.plugins.azw4_input import AZW4Input
# from article_epub.calibre.ebooks.conversion.plugins.chm_input import CHMInput
# from article_epub.calibre.ebooks.conversion.plugins.comic_input import ComicInput
# from article_epub.calibre.ebooks.conversion.plugins.djvu_input import DJVUInput
# from article_epub.calibre.ebooks.conversion.plugins.docx_input import DOCXInput
# from article_epub.calibre.ebooks.conversion.plugins.docx_output import DOCXOutput
from article_epub.calibre.ebooks.conversion.plugins.epub_input import EPUBInput
from article_epub.calibre.ebooks.conversion.plugins.epub_output import EPUBOutput
# from article_epub.calibre.ebooks.conversion.plugins.fb2_input import FB2Input
# from article_epub.calibre.ebooks.conversion.plugins.fb2_output import FB2Output
# from article_epub.calibre.ebooks.conversion.plugins.html_input import HTMLInput
# from article_epub.calibre.ebooks.conversion.plugins.html_output import HTMLOutput
# from article_epub.calibre.ebooks.conversion.plugins.htmlz_input import HTMLZInput
# from article_epub.calibre.ebooks.conversion.plugins.htmlz_output import HTMLZOutput
# from article_epub.calibre.ebooks.conversion.plugins.lit_input import LITInput
# from article_epub.calibre.ebooks.conversion.plugins.lit_output import LITOutput
# from article_epub.calibre.ebooks.conversion.plugins.lrf_input import LRFInput
# from article_epub.calibre.ebooks.conversion.plugins.lrf_output import LRFOutput
# from article_epub.calibre.ebooks.conversion.plugins.mobi_input import MOBIInput
# from article_epub.calibre.ebooks.conversion.plugins.mobi_output import AZW3Output, MOBIOutput
# from article_epub.calibre.ebooks.conversion.plugins.odt_input import ODTInput
# from article_epub.calibre.ebooks.conversion.plugins.oeb_output import OEBOutput
# from article_epub.calibre.ebooks.conversion.plugins.pdb_input import PDBInput
# from article_epub.calibre.ebooks.conversion.plugins.pdb_output import PDBOutput
# from article_epub.calibre.ebooks.conversion.plugins.pdf_input import PDFInput
# from article_epub.calibre.ebooks.conversion.plugins.pdf_output import PDFOutput
# from article_epub.calibre.ebooks.conversion.plugins.pml_input import PMLInput
# from article_epub.calibre.ebooks.conversion.plugins.pml_output import PMLOutput
# from article_epub.calibre.ebooks.conversion.plugins.rb_input import RBInput
# from article_epub.calibre.ebooks.conversion.plugins.rb_output import RBOutput
# from article_epub.calibre.ebooks.conversion.plugins.recipe_input import RecipeInput
# from article_epub.calibre.ebooks.conversion.plugins.rtf_input import RTFInput
# from article_epub.calibre.ebooks.conversion.plugins.rtf_output import RTFOutput
# from article_epub.calibre.ebooks.conversion.plugins.snb_input import SNBInput
# from article_epub.calibre.ebooks.conversion.plugins.snb_output import SNBOutput
# from article_epub.calibre.ebooks.conversion.plugins.tcr_input import TCRInput
# from article_epub.calibre.ebooks.conversion.plugins.tcr_output import TCROutput
# from article_epub.calibre.ebooks.conversion.plugins.txt_input import TXTInput
# from article_epub.calibre.ebooks.conversion.plugins.txt_output import TXTOutput, TXTZOutput
...
# Catalog plugins {{{
# from article_epub.calibre.library.catalogs.bibtex import BIBTEX
# from article_epub.calibre.library.catalogs.csv_xml import CSV_XML
# from article_epub.calibre.library.catalogs.epub_mobi import EPUB_MOBI

# plugins += [CSV_XML, BIBTEX, EPUB_MOBI]
# }}}

# Profiles {{{
from article_epub.calibre.customize.profiles import input_profiles, output_profiles

plugins += input_profiles + output_profiles
# }}}

# Device driver plugins {{{
# from article_epub.calibre.devices.android.driver import ANDROID, S60, WEBOS
# from article_epub.calibre.devices.binatone.driver import README
# from article_epub.calibre.devices.blackberry.driver import BLACKBERRY, PLAYBOOK
# from article_epub.calibre.devices.boeye.driver import BOEYE_BDX, BOEYE_BEX
# from article_epub.calibre.devices.cybook.driver import CYBOOK, DIVA, MUSE, ORIZON
# from article_epub.calibre.devices.eb600.driver import (
#     BOOQ,
#     COOL_ER,
#     DBOOK,
#     EB600,
...
#     TOLINO,
# )
# from article_epub.calibre.devices.edge.driver import EDGE
# from article_epub.calibre.devices.eslick.driver import EBK52, ESLICK
# from article_epub.calibre.devices.folder_device.driver import FOLDER_DEVICE_FOR_CONFIG
# from article_epub.calibre.devices.hanlin.driver import BOOX, HANLINV3, HANLINV5, SPECTRA
# from article_epub.calibre.devices.hanvon.driver import ALEX, AZBOOKA, EB511, KIBANO, LIBREAIR, N516, ODYSSEY, THEBOOK
# from article_epub.calibre.devices.iliad.driver import ILIAD
# from article_epub.calibre.devices.irexdr.driver import IREXDR800, IREXDR1000
# from article_epub.calibre.devices.iriver.driver import IRIVER_STORY
# from article_epub.calibre.devices.jetbook.driver import JETBOOK, JETBOOK_COLOR, JETBOOK_MINI, MIBUK
# from article_epub.calibre.devices.kindle.driver import KINDLE, KINDLE2, KINDLE_DX, KINDLE_FIRE
# from article_epub.calibre.devices.kobo.driver import KOBO, KOBOTOUCH
# from article_epub.calibre.devices.misc import (
#     ADAM,
#     ALURATEK_COLOR,
#     AVANT,
#     CERVANTES,
...
#     WOXTER,
# )
# from article_epub.calibre.devices.mtp.driver import MTP_DEVICE
# from article_epub.calibre.devices.nokia.driver import E52, E71X, N770, N810
# from article_epub.calibre.devices.nook.driver import NOOK, NOOK_COLOR
# from article_epub.calibre.devices.nuut2.driver import NUUT2
# from article_epub.calibre.devices.prs505.driver import PRS505
# from article_epub.calibre.devices.prst1.driver import PRST1
# from article_epub.calibre.devices.smart_device_app.driver import SMART_DEVICE_APP
# from article_epub.calibre.devices.sne.driver import SNE
# from article_epub.calibre.devices.teclast.driver import ARCHOS7O, IPAPYRUS, NEWSMY, PICO, SOVOS, STASH, SUNSTECH_EB700, TECLAST_K3, WEXLER
# from article_epub.calibre.devices.user_defined.driver import USER_DEFINED
...
# from article_epub.calibre.ebooks.metadata.sources.amazon import Amazon
# from article_epub.calibre.ebooks.metadata.sources.big_book_search import BigBookSearch
# from article_epub.calibre.ebooks.metadata.sources.edelweiss import Edelweiss
# from article_epub.calibre.ebooks.metadata.sources.google import GoogleBooks
# from article_epub.calibre.ebooks.metadata.sources.google_images import GoogleImages
# from article_epub.calibre.ebooks.metadata.sources.openlibrary import OpenLibrary

...
from article_epub.calibre.polyglot_builtins import builtins
...
from article_epub.calibre.constants import DEBUG, isfreebsd, islinux, ismacos, iswindows
...
def initialize_calibre():
    ...
    from article_epub.calibre.ptempfile import base_dir
    try:
        base_dir()
    except OSError:
    ...
    #
    # Setup resources
    import article_epub.calibre.utils.resources as resources
    resources

    #
    # Setup translations
    from article_epub.calibre.utils.localization import getlangcode_from_envvars, set_translators
    ...
    from article_epub.calibre.utils.icu import title_case

...
class NIH(Publisher):
    ...
    def epubify(self, output=None):
        ...
        pdf_link = self.soup.find("div", class_="format-menu").find_all("a")[2]["href"]
        epub_link = "http://ncbi.nlm.nih.gov" + str(pdf_link).replace("pdf", "epub")
        ...
        with open(output_raw, "wb") as f:
            ...
            f.close()
        subprocess.check_output(["ebook-convert", output_raw, self.output, "--authors", all_authors])
        print("done")

...
class Wiley(Publisher):
    ...
    def check_fulltext(self):
        ...
        try:
            if full != None:
                if full.find("div", class_="article-section__content").text == "\n\xa0\n":
    ...
    def get_abstract(self):
        ...
        self.abstract = self.soup.find("section", class_="article-section__abstract")

    def get_keywords(self):
        """Get article keywords"""
        self.keywords = []
        try:
            keywords_raw = self.soup.find("section", class_="keywords").find_all("a", class_="badge-type")
    ...
    def get_references(self):
        """Get references list"""
        references_raw = str(self.soup.find("section", {"id": "references-section"}))
